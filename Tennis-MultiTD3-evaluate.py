...
def main():
    ...
    config.noise_scheduler = Scheduler(1.0, 0.1, config.max_t * 1, warmup_steps=config.max_t)
    ...
    agent.load("runs/Sep02_12-18-14_TD3 Embedded Unity Tennis/checkpoint_1300.pth")
